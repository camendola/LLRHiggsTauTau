...
PROCESS = ["OVERLAP_TEST_SIGNAL"]
tag = "MC_SM_nonresonant"
datasetsFile = "datasets.txt"
...
for dtset in dtsetToLaunch:
    ...
    command += " Data.outLFNDirBase=/store/user/camendol/HHNtuples/%s/%s" % (tag , str(counter)+"_"+dtsetNames) # change to where you want to stage you ntuples
