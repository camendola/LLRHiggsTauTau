...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/grid_mnt/data__data.polcms/cms/amendola/miniAOD/D8601366-943A-E611-A2DD-A0000420FE80.root')
)
...
process.SVllCand = cms.EDProducer("SVfitInterface",
    computeForUpDownTES = cms.bool(True),
    srcCov = cms.InputTag("METSignificance","METCovariance"),
    srcMET = cms.InputTag("slimmedMETs"),
    srcPairs = cms.InputTag("barellCand"),
    srcSig = cms.InputTag("METSignificance","METSignificance"),
...
process.softTaus = cms.EDProducer("TauFiller",
    ApplyTESCentralCorr = cms.bool(True),
    NominalTESCorrection = cms.double(-1),
...
process.bareSoftMuons = cms.EDFilter("PATMuonRefSelector",
    cut = cms.string('isLooseMuon && pt>5'),
    src = cms.InputTag("slimmedMuons")
)
...
process.HTauTauTree = cms.EDAnalyzer("HTauTauNtuplizer",
    ...
    triggerList = cms.VPSet(cms.PSet(
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(999),
            path1 = cms.vstring('hltEle25WPTightGsfTrackIsoFilter'),
            path2 = cms.vstring('')
        ), 
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(999),
            path1 = cms.vstring('hltEle25erWPLooseGsfTrackIsoFilter'),
            path2 = cms.vstring('')
        ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(999),
            path1 = cms.vstring('hltEle25erWPTightGsfTrackIsoFilter'),
            path2 = cms.vstring('')
        ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(999),
            path1 = cms.vstring('hltEle27erWPLooseGsfTrackIsoFilter'),
            path2 = cms.vstring('')
        ), 
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(999),
            path1 = cms.vstring('hltEle27erWPTightGsfTrackIsoFilter'),
            path2 = cms.vstring('')
        ), 
        cms.PSet(
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(13),
            leg2 = cms.int32(15),
            path1 = cms.vstring('hltL3crIsoL1sSingleMu20erIorSingleMu22erL1f0L2f10QL3f21QL3trkIsoFiltered0p09', 
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(15),
            path1 = cms.vstring('hltEle22WPLooseL1SingleIsoEG20erGsfTrackIsoFilter', 
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(15),
            path1 = cms.vstring('hltEle24WPLooseL1IsoEG22erTau20erGsfTrackIsoFilter', 
        ...
        cms.PSet(
            ...
            leg1 = cms.int32(11),
            leg2 = cms.int32(15),
            path1 = cms.vstring('hltEle24WPLooseL1SingleIsoEG22erGsfTrackIsoFilter', 
...
process.Candidates = cms.Sequence(process.nEventsTotal+process.nEventsPassTrigger+process.muons+process.electrons+process.cleanSoftElectrons+process.taus+process.fsrSequence+process.softLeptons+process.barellCand+process.jecSequence+process.jets+process.METSequence+process.geninfo+process.SVFit)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('HTauTauAnalysis_2.root')
)
